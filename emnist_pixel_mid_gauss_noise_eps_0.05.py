...
estfile = open("em_est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
estfile.write("EMNIST: Estimated KL Divergence In Order\n")
estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
ratiofile = open("em_ratio_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
ratiofile.write("EMNIST: Ratio Between Exact KL Divergence And Estimator\n")
ratiofile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
ratiofile.write("Closer to 1 corresponds to a better estimate\n\n")

# CHECK WHETHER RANKING IS PRESERVED WHEN ESTIMATOR IS USEDd
DATA_ROWS = 90
TOP_COUNT = 0
BOTTOM_COUNT = 0
...
l0estfile = open("em_l0est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l0estfile.write("EMNIST: Unbiased Estimator Lambda Zero\n")
l0estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l1estfile = open("em_l1est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l1estfile.write("EMNIST: Unbiased Estimator Lambda One\n")
l1estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l2estfile = open("em_l2est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l2estfile.write("EMNIST: Unbiased Estimator Lambda Five\n")
l2estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l3estfile = open("em_l3est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l3estfile.write("EMNIST: Unbiased Estimator Lambda Six\n")
l3estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l4estfile = open("em_l4est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l4estfile.write("EMNIST: Unbiased Estimator Lambda Next\n")
l4estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l5estfile = open("em_l5est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l5estfile.write("EMNIST: Unbiased Estimator Lambda High\n")
l5estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l6estfile = open("em_l6est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l6estfile.write("EMNIST: Unbiased Estimator Lambda Low\n")
l6estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l7estfile = open("em_l7est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l7estfile.write("EMNIST: Unbiased Estimator Lambda Decide\n")
l7estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l8estfile = open("em_l8est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l8estfile.write("EMNIST: Unbiased Estimator Lambda Minus\n")
l8estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l9estfile = open("em_l9est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l9estfile.write("EMNIST: Unbiased Estimator Lambda Triple\n")
l9estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l10estfile = open("em_l10est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l10estfile.write("EMNIST: Unbiased Estimator Lambda Min\n")
l10estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l11estfile = open("em_l11est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l11estfile.write("EMNIST: Unbiased Estimator Lambda Max\n")
l11estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l12estfile = open("em_l12est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l12estfile.write("EMNIST: Unbiased Estimator Lambda Pos\n")
l12estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
...
l13estfile = open("em_l13est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
l13estfile.write("EMNIST: Unbiased Estimator Lambda Neg\n")
l13estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.05\n")
