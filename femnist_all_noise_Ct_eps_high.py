...
ax2.figure.savefig("Eps_mid_exp1_femnist_Ct_est_a_270.png")
plt.close()
...
ax3.figure.savefig("Eps_mid_exp1_femnist_Ct_est_a_540.png")
plt.close()
...
ax6.figure.savefig("Eps_mid_exp1_femnist_Ct_est_b_540.png")
plt.close()
...
ax9.figure.savefig("Eps_mid_exp1_femnist_Ct_est_c_540.png")
plt.close()
