...
print(f"\naLambda: {aLambda[0]}")
plt.errorbar(epsset, aLambda[0], yerr = np.std(aLambda[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss')
plt.errorbar(epsset, aLambda[1], yerr = np.std(aLambda[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc')
plt.errorbar(epsset, aLambda[2], yerr = np.std(aLambda[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(epsset, aLambda[3], yerr = np.std(aLambda[3], axis = 0), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(epsset, aLambda[4], yerr = np.std(aLambda[4], axis = 0), color = 'tab:red', marker = 'o', label = 'end lap')
plt.errorbar(epsset, aLambda[5], yerr = np.std(aLambda[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'end lap mc')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator")
plt.title("How epsilon affects lambda (sum)")
plt.savefig("Femnist_eps_mid_lambda_sum.png")
plt.clf()

plt.errorbar(epsset, aPairLambda[0], yerr = np.std(aPairLambda[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss: min')
plt.errorbar(epsset, bPairLambda[0], yerr = np.std(aPairLambda[0], axis = 0), color = 'tab:blue', marker = 'x', label = 'end gauss: max')
plt.errorbar(epsset, aPairLambda[1], yerr = np.std(aPairLambda[1], axis = 0), color = 'tab:cyan', marker = 'o', label = 'end gauss mc: min')
plt.errorbar(epsset, bPairLambda[1], yerr = np.std(aPairLambda[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc: max')
plt.errorbar(epsset, aPairLambda[2], yerr = np.std(aPairLambda[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss: min')
plt.errorbar(epsset, bPairLambda[2], yerr = np.std(aPairLambda[2], axis = 0), color = 'tab:olive', marker = 'x', label = 'mid gauss: max')
plt.errorbar(epsset, aPairLambda[3], yerr = np.std(aPairLambda[3], axis = 0), color = 'tab:green', marker = 'o', label = 'mid gauss mc: min')
plt.errorbar(epsset, bPairLambda[3], yerr = np.std(aPairLambda[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc: max')
plt.errorbar(epsset, aPairLambda[4], yerr = np.std(aPairLambda[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap: min')
plt.errorbar(epsset, bPairLambda[4], yerr = np.std(aPairLambda[4], axis = 0), color = 'tab:red', marker = 'x', label = 'mid lap: max')
plt.errorbar(epsset, aPairLambda[5], yerr = np.std(aPairLambda[5], axis = 0), color = 'tab:pink', marker = 'o', label = 'mid lap mc: min')
plt.errorbar(epsset, bPairLambda[5], yerr = np.std(aPairLambda[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: max')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator")
plt.title("How epsilon affects lambda (min/max pair)")
plt.savefig("Femnist_eps_mid_lambda_min_max.png")
plt.clf()

# plot sum / estimates for each epsilon
print(f"aSum: {aSum[0]}")
plt.errorbar(epsset, aSum[0], yerr = np.std(aSum[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss')
plt.errorbar(epsset, aSum[1], yerr = np.std(aSum[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc')
plt.errorbar(epsset, aSum[2], yerr = np.std(aSum[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss')
plt.errorbar(epsset, aSum[3], yerr = np.std(aSum[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc')
plt.errorbar(epsset, aSum[4], yerr = np.std(aSum[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap')
plt.errorbar(epsset, aSum[5], yerr = np.std(aSum[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc')
plt.legend(loc = 'best')
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (sum)")
plt.title("How epsilon affects error of unbiased estimator (sum)")
plt.savefig("Femnist_eps_mid_est_sum.png")
plt.clf()

plt.errorbar(epsset, aPairEst[0], yerr = np.std(aPairEst[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss: min')
plt.errorbar(epsset, bPairEst[0], yerr = np.std(aPairEst[0], axis = 0), color = 'tab:blue', marker = 'x', label = 'end gauss: max')
plt.errorbar(epsset, aPairEst[1], yerr = np.std(aPairEst[1], axis = 0), color = 'tab:cyan', marker = 'o', label = 'end gauss mc: min')
plt.errorbar(epsset, bPairEst[1], yerr = np.std(aPairEst[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc: max')
plt.errorbar(epsset, aPairEst[2], yerr = np.std(aPairEst[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss: min')
plt.errorbar(epsset, bPairEst[2], yerr = np.std(aPairEst[2], axis = 0), color = 'tab:olive', marker = 'x', label = 'mid gauss: max')
plt.errorbar(epsset, aPairEst[3], yerr = np.std(aPairEst[3], axis = 0), color = 'tab:green', marker = 'o', label = 'mid gauss mc: min')
plt.errorbar(epsset, bPairEst[3], yerr = np.std(aPairEst[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc: max')
plt.errorbar(epsset, aPairEst[4], yerr = np.std(aPairEst[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap: min')
plt.errorbar(epsset, bPairEst[4], yerr = np.std(aPairEst[4], axis = 0), color = 'tab:red', marker = 'x', label = 'mid lap: max')
plt.errorbar(epsset, aPairEst[5], yerr = np.std(aPairEst[5], axis = 0), color = 'tab:pink', marker = 'o', label = 'mid lap mc: min')
plt.errorbar(epsset, bPairEst[5], yerr = np.std(aPairEst[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: max')
plt.legend(loc = 'best')
plt.yscale('log')
plt.xlabel("Value of epsilon")
...
plt.savefig("Femnist_eps_mid_est_min_max.png")
plt.clf()

# plot ranking preservations for each epsilon
plt.errorbar(epsset, aPercSmall[0], yerr = np.std(aPercSmall[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss: smallest 10%')
plt.errorbar(epsset, aPercLarge[0], yerr = np.std(aPercLarge[0], axis = 0), color = 'tab:blue', marker = 'x', label = 'end gauss: largest 10%')
plt.errorbar(epsset, aPercSmall[1], yerr = np.std(aPercSmall[1], axis = 0), color = 'tab:cyan', marker = 'o', label = 'end gauss mc: smallest 10%')
plt.errorbar(epsset, aPercLarge[1], yerr = np.std(aPercLarge[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc: largest 10%')
plt.errorbar(epsset, aPercSmall[2], yerr = np.std(aPercSmall[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss: smallest 10%')
plt.errorbar(epsset, aPercLarge[2], yerr = np.std(aPercLarge[2], axis = 0), color = 'tab:olive', marker = 'x', label = 'mid gauss: largest 10%')
plt.errorbar(epsset, aPercSmall[3], yerr = np.std(aPercSmall[3], axis = 0), color = 'tab:green', marker = 'o', label = 'mid gauss mc: smallest 10%')
plt.errorbar(epsset, aPercLarge[3], yerr = np.std(aPercLarge[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc: largest 10%')
plt.errorbar(epsset, aPercSmall[4], yerr = np.std(aPercSmall[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap: smallest 10%')
plt.errorbar(epsset, aPercLarge[4], yerr = np.std(aPercLarge[4], axis = 0), color = 'tab:red', marker = 'x', label = 'mid lap: largest 10%')
plt.errorbar(epsset, aPercSmall[5], yerr = np.std(aPercSmall[5], axis = 0), color = 'tab:pink', marker = 'o', label = 'mid lap mc: smallest 10%')
plt.errorbar(epsset, aPercLarge[5], yerr = np.std(aPercLarge[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: largest 10%')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel(f"% staying in smaller/larger half")
plt.title("Ranking preservation for true distribution")
plt.savefig("Femnist_eps_mid_perc_ratio.png")
plt.clf()

plt.errorbar(epsset, bPercSmall[0], yerr = np.std(bPercSmall[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss: smallest 10%')
plt.errorbar(epsset, bPercLarge[0], yerr = np.std(bPercLarge[0], axis = 0), color = 'tab:blue', marker = 'x', label = 'end gauss: largest 10%')
plt.errorbar(epsset, bPercSmall[1], yerr = np.std(bPercSmall[1], axis = 0), color = 'tab:cyan', marker = 'o', label = 'end gauss mc: smallest 10%')
plt.errorbar(epsset, bPercLarge[1], yerr = np.std(bPercLarge[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc: largest 10%')
plt.errorbar(epsset, bPercSmall[2], yerr = np.std(bPercSmall[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss: smallest 10%')
plt.errorbar(epsset, bPercLarge[2], yerr = np.std(bPercLarge[2], axis = 0), color = 'tab:olive', marker = 'x', label = 'mid gauss: largest 10%')
plt.errorbar(epsset, bPercSmall[3], yerr = np.std(bPercSmall[3], axis = 0), color = 'tab:green', marker = 'o', label = 'mid gauss mc: smallest 10%')
plt.errorbar(epsset, bPercLarge[3], yerr = np.std(bPercLarge[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc: largest 10%')
plt.errorbar(epsset, bPercSmall[4], yerr = np.std(bPercSmall[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap: smallest 10%')
plt.errorbar(epsset, bPercLarge[4], yerr = np.std(bPercLarge[4], axis = 0), color = 'tab:red', marker = 'x', label = 'mid lap: largest 10%')
plt.errorbar(epsset, bPercSmall[5], yerr = np.std(bPercSmall[5], axis = 0), color = 'tab:pink', marker = 'o', label = 'mid lap mc: smallest 10%')
plt.errorbar(epsset, bPercLarge[5], yerr = np.std(bPercLarge[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: largest 10%')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel(f"% staying in smaller/larger half")
plt.title("Ranking preservation for error of unbiased estimator (sum)")
plt.savefig("Femnist_eps_mid_perc_sum.png")
plt.clf()

plt.errorbar(epsset, cPercSmall[0], yerr = np.std(cPercSmall[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss: smallest 10%')
plt.errorbar(epsset, cPercLarge[0], yerr = np.std(cPercLarge[0], axis = 0), color = 'tab:blue', marker = 'x', label = 'end gauss: largest 10%')
plt.errorbar(epsset, cPercSmall[1], yerr = np.std(cPercSmall[1], axis = 0), color = 'tab:cyan', marker = 'o', label = 'end gauss mc: smallest 10%')
plt.errorbar(epsset, cPercLarge[1], yerr = np.std(cPercLarge[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc: largest 10%')
plt.errorbar(epsset, cPercSmall[2], yerr = np.std(cPercSmall[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss: smallest 10%')
plt.errorbar(epsset, cPercLarge[2], yerr = np.std(cPercLarge[2], axis = 0), color = 'tab:olive', marker = 'x', label = 'mid gauss: largest 10%')
plt.errorbar(epsset, cPercSmall[3], yerr = np.std(cPercSmall[3], axis = 0), color = 'tab:green', marker = 'o', label = 'mid gauss mc: smallest 10%')
plt.errorbar(epsset, cPercLarge[3], yerr = np.std(cPercLarge[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc: largest 10%')
plt.errorbar(epsset, cPercSmall[4], yerr = np.std(cPercSmall[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap: smallest 10%')
plt.errorbar(epsset, cPercLarge[4], yerr = np.std(cPercLarge[4], axis = 0), color = 'tab:red', marker = 'x', label = 'mid lap: largest 10%')
plt.errorbar(epsset, cPercSmall[5], yerr = np.std(cPercSmall[5], axis = 0), color = 'tab:pink', marker = 'o', label = 'mid lap mc: smallest 10%')
plt.errorbar(epsset, cPercLarge[5], yerr = np.std(cPercLarge[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: largest 10%')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel(f"% staying in smaller/larger half")
plt.title("Ranking preservation for error of unbiased estimator (min pair)")
plt.savefig("Femnist_eps_mid_perc_min.png")
plt.clf()

plt.errorbar(epsset, dPercSmall[0], yerr = np.std(dPercSmall[0], axis = 0), color = 'tab:blue', marker = 'o', label = 'end gauss: smallest 10%')
plt.errorbar(epsset, dPercLarge[0], yerr = np.std(dPercLarge[0], axis = 0), color = 'tab:blue', marker = 'x', label = 'end gauss: largest 10%')
plt.errorbar(epsset, dPercSmall[1], yerr = np.std(dPercSmall[1], axis = 0), color = 'tab:cyan', marker = 'o', label = 'end gauss mc: smallest 10%')
plt.errorbar(epsset, dPercLarge[1], yerr = np.std(dPercLarge[1], axis = 0), color = 'tab:cyan', marker = 'x', label = 'end gauss mc: largest 10%')
plt.errorbar(epsset, dPercSmall[2], yerr = np.std(dPercSmall[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss: smallest 10%')
plt.errorbar(epsset, dPercLarge[2], yerr = np.std(dPercLarge[2], axis = 0), color = 'tab:olive', marker = 'x', label = 'mid gauss: largest 10%')
plt.errorbar(epsset, dPercSmall[3], yerr = np.std(dPercSmall[3], axis = 0), color = 'tab:green', marker = 'o', label = 'mid gauss mc: smallest 10%')
plt.errorbar(epsset, dPercLarge[3], yerr = np.std(dPercLarge[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc: largest 10%')
plt.errorbar(epsset, dPercSmall[4], yerr = np.std(dPercSmall[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap: smallest 10%')
plt.errorbar(epsset, dPercLarge[4], yerr = np.std(dPercLarge[4], axis = 0), color = 'tab:red', marker = 'x', label = 'mid lap: largest 10%')
plt.errorbar(epsset, dPercSmall[5], yerr = np.std(dPercSmall[5], axis = 0), color = 'tab:pink', marker = 'o', label = 'mid lap mc: smallest 10%')
plt.errorbar(epsset, dPercLarge[5], yerr = np.std(dPercLarge[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: largest 10%')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel(f"% staying in smaller/larger half")
plt.title("Ranking preservation for error of unbiased estimator (max pair)")
plt.savefig("Femnist_eps_mid_perc_max.png")
