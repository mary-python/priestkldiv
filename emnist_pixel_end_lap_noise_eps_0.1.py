...
for C in range(0, 10):
    for D in range(0, 10):
        ...
        if ratio != 0.0 and sum(KLDiv[C, D]) != 0.0:
            ...
            unbias_est(0.1, ratio, lTwoKList, lTwoCDList, C, D, 0)
            unbias_est(0.2, ratio, lThreeKList, lThreeCDList, C, D, 0)
            unbias_est(0.3, ratio, lNextKList, lNextCDList, C, D, 0)
            unbias_est(0.4, ratio, lHighKList, lHighCDList, C, D, 0)
            unbias_est(0.5, ratio, lLowKList, lLowCDList, C, D, 0)
            unbias_est(0.6, ratio, lDecideKList, lDecideCDList, C, D, 0)
            ...
            unbias_est(0.2, ratio, lMinKList, lMinCDList, C, D, 0)
            unbias_est(0.4, ratio, lMaxKList, lMaxCDList, C, D, 0)
...
estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_est.txt", "w", encoding = 'utf-8')
...
ratiofile = open(f"em_kld_end_lap_noise_eps_{EPS}_ratio.txt", "w", encoding = 'utf-8')
...
l0estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l0est.txt", "w", encoding = 'utf-8')
...
l1estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l1est.txt", "w", encoding = 'utf-8')
...
l2estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l2est.txt", "w", encoding = 'utf-8')
...
l3estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l3est.txt", "w", encoding = 'utf-8')
l3estfile.write("EMNIST: Unbiased Estimator Lambda = 0.2\n")
...
l4estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l4est.txt", "w", encoding = 'utf-8')
l4estfile.write("EMNIST: Unbiased Estimator Lambda = 0.3\n")
...
l5estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l5est.txt", "w", encoding = 'utf-8')
l5estfile.write("EMNIST: Unbiased Estimator Lambda = 0.4\n")
...
l6estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l6est.txt", "w", encoding = 'utf-8')
l6estfile.write("EMNIST: Unbiased Estimator Lambda = 0.5\n")
...
l7estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l7est.txt", "w", encoding = 'utf-8')
...
l8estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l8est.txt", "w", encoding = 'utf-8')
...
l9estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l9est.txt", "w", encoding = 'utf-8')
...
l10estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l10est.txt", "w", encoding = 'utf-8')
...
l11estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l11est.txt", "w", encoding = 'utf-8')
...
l12estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l12est.txt", "w", encoding = 'utf-8')
...
l13estfile = open(f"em_kld_end_lap_noise_eps_{EPS}_l13est.txt", "w", encoding = 'utf-8')
