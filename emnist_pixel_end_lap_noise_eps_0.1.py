...
for C in range(0, 10):
    for D in range(0, 10):
        ...
        if ratio != 0.0 and sum(KLDiv[C, D]) != 0.0:
            ...
            unbias_est(0.5, ratio, lTwoKList, lTwoCDList, C, D, 0)
            unbias_est(0.1, ratio, lThreeKList, lThreeCDList, C, D, 0)
            unbias_est(0.9, ratio, lNextKList, lNextCDList, C, D, 0)
            unbias_est(0.6, ratio, lHighKList, lHighCDList, C, D, 0)
            unbias_est(0.2, ratio, lLowKList, lLowCDList, C, D, 0)
            unbias_est(0.7, ratio, lDecideKList, lDecideCDList, C, D, 0)
            ...
            unbias_est(0.9, ratio, lMinKList, lMinCDList, C, D, 0)
            unbias_est(0.155, ratio, lMaxKList, lMaxCDList, C, D, 0)
...
l3estfile.write("EMNIST: Unbiased Estimator Lambda = 0.1\n")
...
l4estfile.write("EMNIST: Unbiased Estimator Lambda = 0.9\n")
...
l5estfile.write("EMNIST: Unbiased Estimator Lambda = 0.6\n")
...
l6estfile.write("EMNIST: Unbiased Estimator Lambda = 0.2\n")
...
l10estfile.write("EMNIST: Unbiased Estimator Optimal Lambda Min Pair (0, 5)\n")
