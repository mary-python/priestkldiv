...
for trial in range(14):
    ...
    for C in Cset:
        ...
        # clients or intermediate server already added Gaussian noise term
            ...
            # C = 40 (small)
            rMeanCSmall[trial, C_COUNT] = (rMeanCSmall[trial, C_COUNT] - groundTruth)**2
            oMeanCSmall[trial, C_COUNT] = (oMeanCSmall[trial, C_COUNT] - groundTruth)**2

            # C = 200 (def)
            rMeanCDef[trial, C_COUNT] = (rMeanCDef[trial, C_COUNT] - groundTruth)**2
            oMeanCDef[trial, C_COUNT] = (oMeanCDef[trial, C_COUNT] - groundTruth)**2

            # C = 400 (mid)
            rMeanCMid[trial, C_COUNT] = (rMeanCMid[trial, C_COUNT] - groundTruth)**2
            oMeanCMid[trial, C_COUNT] = (oMeanCMid[trial, C_COUNT] - groundTruth)**2

            # C = 620 (large)
            rMeanCLarge[trial, C_COUNT] = (rMeanCLarge[trial, C_COUNT] - groundTruth)**2
            oMeanCLarge[trial, C_COUNT] = (oMeanCLarge[trial, C_COUNT] - groundTruth)**2
...
# plot error of PRIEST-KLD when C = 40 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 40 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 40 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 40 (large KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 200 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 200 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 200 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 200 (large KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 400 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 400 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 400 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 400 (large KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 620 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 620 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when C = 620 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when C = 620 (large KLD, ordered, mc)
