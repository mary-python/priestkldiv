...
for trial in range(8):
    ...
    for C in Cset:
        ...
        rTempMeanCSmall = np.zeros((RS, LS))
        rTempMeanCDef = np.zeros((RS, LS))
        rTempMeanCMid = np.zeros((RS, LS))
        rTempMeanCLarge = np.zeros((RS, LS))
        ...
        oTempMeanCSmall = np.zeros((RS, LS))
        oTempMeanCDef = np.zeros((RS, LS))
        oTempMeanCMid = np.zeros((RS, LS))
        oTempMeanCLarge = np.zeros((RS, LS))
...
plt.plot(Cset, rLdaOpt[0], yerr = np.minimum(rLdaOptRange[0], np.sqrt(rLdaOpt[0]), np.divide(rLdaOpt[0], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, rLdaOpt[1], yerr = np.minimum(rLdaOptRange[1], np.sqrt(rLdaOpt[1]), np.divide(rLdaOpt[1], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, rLdaOpt[2], yerr = np.minimum(rLdaOptRange[2], np.sqrt(rLdaOpt[2]), np.divide(rLdaOpt[2], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.xlabel("Value of C")
...
plt.plot(Cset, oLdaOpt[0], yerr = np.minimum(oLdaOptRange[0], np.sqrt(oLdaOpt[0]), np.divide(oLdaOpt[0], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, oLdaOpt[1], yerr = np.minimum(oLdaOptRange[1], np.sqrt(oLdaOpt[1]), np.divide(oLdaOpt[1], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, oLdaOpt[2], yerr = np.minimum(oLdaOptRange[2], np.sqrt(oLdaOpt[2]), np.divide(oLdaOpt[2], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.xlabel("Value of C")
plt.ylabel("Lambda to minimise error of PRIEST-KLD")
...
plt.plot(Cset, rLdaOpt[3], yerr = np.minimum(rLdaOptRange[3], np.sqrt(rLdaOpt[3]), np.divide(rLdaOpt[3], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, rLdaOpt[4], yerr = np.minimum(rLdaOptRange[4], np.sqrt(rLdaOpt[4]), np.divide(rLdaOpt[4], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, rLdaOpt[5], yerr = np.minimum(rLdaOptRange[5], np.sqrt(rLdaOpt[5]), np.divide(rLdaOpt[5], 2)),color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.xlabel("Value of C")
plt.ylabel("Lambda to minimise error of PRIEST-KLD")
...
plt.plot(Cset, oLdaOpt[3], yerr = np.minimum(oLdaOptRange[3], np.sqrt(oLdaOpt[3]), np.divide(oLdaOpt[3], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, oLdaOpt[4], yerr = np.minimum(oLdaOptRange[4], np.sqrt(oLdaOpt[4]), np.divide(oLdaOpt[4], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, oLdaOpt[5], yerr = np.minimum(oLdaOptRange[5], np.sqrt(oLdaOpt[5]), np.divide(oLdaOpt[5], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.xlabel("Value of C")
plt.ylabel("Lambda to minimise error of PRIEST-KLD")
...
plt.plot(Cset, rMeanPerc[0], yerr = np.minimum(rMeanPercRange[0], np.sqrt(rMeanPerc[0]), np.divide(rMeanPerc[0], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, rMeanPerc[1], yerr = np.minimum(rMeanPercRange[1], np.sqrt(rMeanPerc[1]), np.divide(rMeanPerc[1], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, rMeanPerc[2], yerr = np.minimum(rMeanPercRange[2], np.sqrt(rMeanPerc[2]), np.divide(rMeanPerc[2], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.yscale('log')
...
plt.plot(Cset, oMeanPerc[0], yerr = np.minimum(oMeanPercRange[0], np.sqrt(rMeanPerc[0]), np.divide(rMeanPerc[0], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, oMeanPerc[1], yerr = np.minimum(oMeanPercRange[1], np.sqrt(rMeanPerc[1]), np.divide(rMeanPerc[1], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, oMeanPerc[2], yerr = np.minimum(oMeanPercRange[2], np.sqrt(rMeanPerc[2]), np.divide(rMeanPerc[2], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.yscale('log')
...
plt.plot(Cset, rMeanPerc[3], yerr = np.minimum(rMeanPercRange[3], np.sqrt(rMeanPerc[3]), np.divide(rMeanPerc[3], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, rMeanPerc[4], yerr = np.minimum(rMeanPercRange[4], np.sqrt(rMeanPerc[4]), np.divide(rMeanPerc[4], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, rMeanPerc[5], yerr = np.minimum(rMeanPercRange[5], np.sqrt(rMeanPerc[5]), np.divide(rMeanPerc[5], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.yscale('log')
...
plt.plot(Cset, oMeanPerc[3], yerr = np.minimum(oMeanPercRange[3], np.sqrt(rMeanPerc[3]), np.divide(rMeanPerc[3], 2)), color = 'blue', marker = 'o', label = "Dist")
plt.plot(Cset, oMeanPerc[4], yerr = np.minimum(oMeanPercRange[4], np.sqrt(rMeanPerc[4]), np.divide(rMeanPerc[4], 2)), color = 'green', marker = 'o', label = "TAgg")
plt.plot(Cset, oMeanPerc[5], yerr = np.minimum(oMeanPercRange[5], np.sqrt(rMeanPerc[5]), np.divide(rMeanPerc[5], 2)), color = 'orange', marker = 'o', label = "Trusted")
plt.legend(loc = 'best')
plt.yscale('log')
