...
plot1 = plt.plot(epsset, sumLambda)
plot1.xlabel("Value of epsilon")
plot1.ylabel("Lambda to minimise KLD for all pairs")
plot1.title("How epsilon affects lambda (all pairs, EMNIST)")
plot1.savefig("Emnist_mid_lap_lambda_sum.png")

plot2 = plt.plot()
plot2.plot(epsset, minPairLambda, color = 'b', label = 'min pair')
plot2.plot(epsset, maxPairLambda, color = 'r', label = 'max pair')
plot2.legend(loc = 'best')
plot2.xlabel("Value of epsilon")
plot2.ylabel("Lambda to minimise KLD for min or max pair")
plot2.title("How epsilon affects lambda (min and max pair, EMNIST)")
plot2.savefig("Emnist_mid_lap_lambda_min_max.png")

# PLOT SUM / ESTIMATES FOR EACH EPSILON
plot3 = plt.plot(epsset, minSum)
plot3.xlabel("Value of epsilon")
plot3.ylabel("Minimal KLD for all pairs")
plot3.title("How epsilon affects minimal KLD (all pairs, EMNIST)")
plot3.savefig("Emnist_mid_lap_est_sum.png")

plot4 = plt.plot()
plot4.plot(epsset, minPairEst, color = 'b', label = 'min pair')
plot4.plot(epsset, maxPairEst, color = 'r', label = 'max pair')
plot4.legend(loc = 'best')
plot4.xlabel("Value of epsilon")
plot4.ylabel("Minimal KLD for min or max pair")
plot4.title("How epsilon affects minimal KLD (min and max pair, EMNIST)")
plot4.savefig("Emnist_mid_lap_est_min_max.png")

# PLOT RANKING PRESERVATIONS FOR EACH EPSILON
plot5 = plt.plot()
plot5.plot(epsset, rPercTopKLD, color = 'b', label = 'top 10%/half')
plot5.plot(epsset, rPercBottomKLD, color = 'r', label = 'bottom 10%/half')
plot5.legend(loc = 'best')
plot5.xlabel("Value of epsilon")
plot5.ylabel(f"Top/bottom 10% staying in top/bottom half")
plot5.title("Ranking preservation for ratio between exact and estimated KLD")
plot5.savefig("Emnist_mid_lap_perc_ratio.png")

plot6 = plt.plot()
plot6.plot(epsset, sumPercTopKLD, color = 'b', label = 'top 10%/half')
plot6.plot(epsset, sumPercBottomKLD, color = 'r', label = 'bottom 10%/half')
plot6.legend(loc = 'best')
plot6.xlabel("Value of epsilon")
plot6.ylabel(f"Top/bottom 10% staying in top/bottom half")
plot6.title("Ranking preservation for minimal KLD (all pairs, EMNIST)")
plot6.savefig("Emnist_mid_lap_perc_sum.png")

plot7 = plt.plot()
plot7.plot(epsset, minPercTopKLD, color = 'b', label = 'top 10%/half')
plot7.plot(epsset, minPercBottomKLD, color = 'r', label = 'bottom 10%/half')
plot7.legend(loc = 'best')
plot7.xlabel("Value of epsilon")
plot7.ylabel(f"Top/bottom 10% staying in top/bottom half")
plot7.title("Ranking preservation for minimal KLD (min pair, EMNIST)")
plot7.savefig("Emnist_mid_lap_perc_min.png")

plot8 = plt.plot()
plot8.plot(epsset, maxPercTopKLD, color = 'b', label = 'top 10%/half')
plot8.plot(epsset, maxPercBottomKLD, color = 'r', label = 'bottom 10%/half')
plot8.legend(loc = 'best')
plot8.xlabel("Value of epsilon")
plot8.ylabel(f"Top/bottom 10% staying in top/bottom half")
plot8.title("Ranking preservation for minimal KLD (max pair, EMNIST)")
plot8.savefig("Emnist_mid_lap_perc_max.png")
