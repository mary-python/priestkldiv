...
for C in range(0, 10):
    for D in range(0, 10):
        ...
        if ratio != 0.0 and sum(KLDiv[C, D]) != 0.0:
            ...
            unbias_est(0.15, ratio, lTwoKList, lTwoCDList, C, D)
            unbias_est(0.155, ratio, lThreeKList, lThreeCDList, C, D)
            unbias_est(0.1547, ratio, lNextKList, lNextCDList, C, D)
            unbias_est(0.15476, ratio, lHighKList, lHighCDList, C, D)
            unbias_est(0.15475, ratio, lLowKList, lLowCDList, C, D)
            unbias_est(0.154752, ratio, lDecideKList, lDecideCDList, C, D)
            ...
            unbias_est(0.08573, ratio, lMinKList, lMinCDList, C, D)
            unbias_est(0.252872, ratio, lMaxKList, lMaxCDList, C, D)
...
estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_est.txt", "w", encoding = 'utf-8')
estfile.write("EMNIST: Estimated KL Divergence In Order\n")
estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
ratiofile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_ratio.txt", "w", encoding = 'utf-8')
ratiofile.write("EMNIST: Ratio Between Exact KL Divergence And Estimator\n")
ratiofile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l0estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l0est.txt", "w", encoding = 'utf-8')
l0estfile.write("EMNIST: Unbiased Estimator Lambda = 0\n")
l0estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l1estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l1est.txt", "w", encoding = 'utf-8')
l1estfile.write("EMNIST: Unbiased Estimator Lambda = 1\n")
l1estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l2estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l2est.txt", "w", encoding = 'utf-8')
l2estfile.write("EMNIST: Unbiased Estimator Lambda = 0.15\n")
l2estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l3estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l3est.txt", "w", encoding = 'utf-8')
l3estfile.write("EMNIST: Unbiased Estimator Lambda = 0.155\n")
l3estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l4estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l4est.txt", "w", encoding = 'utf-8')
l4estfile.write("EMNIST: Unbiased Estimator Lambda = 0.1547\n")
l4estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l5estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l5est.txt", "w", encoding = 'utf-8')
l5estfile.write("EMNIST: Unbiased Estimator Lambda = 0.15476\n")
l5estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l6estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l6est.txt", "w", encoding = 'utf-8')
l6estfile.write("EMNIST: Unbiased Estimator Lambda = 0.15475\n")
l6estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l7estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l7est.txt", "w", encoding = 'utf-8')
l7estfile.write("EMNIST: Unbiased Estimator Optimal Lambda for Sum\n")
l7estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l8estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l8est.txt", "w", encoding = 'utf-8')
l8estfile.write("EMNIST: Unbiased Estimator Lambda = -1\n")
l8estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l9estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l9est.txt", "w", encoding = 'utf-8')
l9estfile.write("EMNIST: Unbiased Estimator Lambda = -3\n")
l9estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l10estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l10est.txt", "w", encoding = 'utf-8')
l10estfile.write("EMNIST: Unbiased Estimator Optimal Lambda Min Pair (7, 1)\n")
l10estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l11estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l11est.txt", "w", encoding = 'utf-8')
l11estfile.write("EMNIST: Unbiased Estimator Optimal Lambda Max Pair (6, 9)\n")
l11estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l12estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l12est.txt", "w", encoding = 'utf-8')
l12estfile.write("EMNIST: Unbiased Estimator Lambda = 10000\n")
l12estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
...
l13estfile = open(f"em_kld_mid_lap_noise_mc_eps_{EPS}_l13est.txt", "w", encoding = 'utf-8')
l13estfile.write("EMNIST: Unbiased Estimator Lambda = -10000\n")
l13estfile.write(f"Laplace Noise in Middle, Monte Carlo, Eps = {EPS}\n")
