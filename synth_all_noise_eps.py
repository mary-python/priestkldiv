...
plt.savefig("Exp1_synth_eps_est_a_0.05.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_a_0.5.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_a_1.5.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_a_3.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_b_0.05.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_b_0.5.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_b_1.5.png")
plt.clf()
...
plt.xlabel("Value of lambda")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp1_synth_eps_est_b_3.png")
plt.clf()
...
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp2_synth_eps_est_a.png")
plt.clf()
...
plt.xlabel("Value of epsilon")
plt.ylabel("MSE of PRIEST-KLD")
plt.savefig("Exp2_synth_eps_est_b.png")
plt.clf()
...
plt.xlabel("Value of epsilon")
plt.ylabel("Noise (%)")
plt.savefig("Exp3_synth_eps_perc_a.png")
plt.clf()
...
plt.xlabel("Value of epsilon")
plt.ylabel("Noise (%)")
plt.savefig("Exp3_synth_eps_perc_b.png")
plt.clf()
