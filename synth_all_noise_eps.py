...
for trial in range(8):
    ...
    for eps in epsset:
        ...
        rTempMeanEpsSmall = np.zeros((RS, LS))
        rTempMeanEpsDef = np.zeros((RS, LS))
        rTempMeanEpsMid = np.zeros((RS, LS))
        rTempMeanEpsLarge = np.zeros((RS, LS))
        ...
        oTempMeanEpsSmall = np.zeros((RS, LS))
        oTempMeanEpsDef = np.zeros((RS, LS))
        oTempMeanEpsMid = np.zeros((RS, LS))
        oTempMeanEpsLarge = np.zeros((RS, LS))
