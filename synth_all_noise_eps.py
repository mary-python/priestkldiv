...
trialset = ["small_start_gauss", "small_start_gauss_mc", "small_mid_gauss", "small_mid_gauss_mc", "small_end_lap", "small_end_lap_mc", "large_start_gauss",
            "large_start_gauss_mc", "large_mid_gauss", "large_mid_gauss_mc", "large_end_lap", "large_end_lap_mc", "small_no_privacy", "large_no_privacy"]
ES = len(epsset)
TS = len(trialset)
...
for trial in range(14):
    ...
    statsfile = open(f"synth_eps_{trialset[trial]}_noise.txt", "w", encoding = 'utf-8')
...
# plot error of unbiased estimator for each epsilon (small KLD, sampled)
...
plt.errorbar(epsset, sMeanEst[12], yerr = np.minimum(np.sqrt(sMeanEst[12]), np.divide(sMeanEst[12], 2)), color = 'red', marker = '*', label = "no noise")
plt.legend(loc = "best")
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (sm KLD, samp)")
plt.title("Effect of epsilon on error of unbiased estimator (sm KLD, samp)")
plt.savefig("Synth_eps_small_samp.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (small KLD, sampled, mc)
...
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (sm KLD, samp, mc)")
plt.title("Effect of epsilon on error of unbiased estimator (sm KLD, samp, mc)")
plt.savefig("Synth_eps_small_samp_mc.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (small KLD, ordered)
...
plt.errorbar(epsset, oMeanEst[12], yerr = np.minimum(np.sqrt(oMeanEst[12]), np.divide(oMeanEst[12], 2)), color = 'red', marker = '*', label = "no noise")
plt.legend(loc = "best")
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (sm KLD, ord)")
plt.title("Effect of epsilon on error of unbiased estimator (sm KLD, ord)")
plt.savefig("Synth_eps_small_ord.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (small KLD, ordered, mc)
...
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (sm KLD, ord, mc)")
plt.title("Effect of epsilon on error of unbiased estimator (sm KLD, ord, mc)")
plt.savefig("Synth_eps_small_ord_mc.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (large KLD, sampled)
...
plt.errorbar(epsset, sMeanEst[13], yerr = np.minimum(np.sqrt(sMeanEst[13]), np.divide(sMeanEst[13], 2)), color = 'red', marker = '*', label = "no noise")
plt.legend(loc = "best")
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (lg KLD, samp)")
plt.title("Effect of epsilon on error of unbiased estimator (lg KLD, samp)")
plt.savefig("Synth_eps_large_samp.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (large KLD, sampled, mc)
...
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (lg KLD, samp, mc)")
plt.title("Effect of epsilon on error of unbiased estimator (lg KLD, samp, mc)")
plt.savefig("Synth_eps_large_samp_mc.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (large KLD, ordered)
...
plt.errorbar(epsset, oMeanEst[13], yerr = np.minimum(np.sqrt(oMeanEst[13]), np.divide(oMeanEst[13], 2)), color = 'red', marker = '*', label = "no noise")
plt.legend(loc = "best")
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (lg KLD, ord)")
plt.title("Effect of epsilon on error of unbiased estimator (lg KLD, ord)")
plt.savefig("Synth_eps_large_ord.png")
plt.clf()

# plot error of unbiased estimator for each epsilon (large KLD, ordered, mc)
...
plt.yscale('log')
plt.xlabel("Value of epsilon")
plt.ylabel("Error of unbiased estimator (lg KLD, ord, mc)")
plt.title("Effect of epsilon on error of unbiased estimator (lg KLD, ord, mc)")
plt.savefig("Synth_eps_large_ord_mc.png")
plt.clf()

# plot optimum lambda for each epsilon (small KLD, sampled)
...
plt.plot(epsset, sLdaOpt[12], color = 'red', marker = '*', label = 'no noise')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (sm KLD, samp)")
plt.title("How epsilon affects optimum lambda (sm KLD, samp)")
plt.savefig("Synth_eps_lda_small_samp.png")
plt.clf()

# plot optimum lambda for each epsilon (small KLD, sampled, mc)
...
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (sm KLD, samp, mc)")
plt.title("How epsilon affects optimum lambda (sm KLD, samp, mc)")
plt.savefig("Synth_eps_lda_small_samp_mc.png")
plt.clf()
...
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (sm KLD, ord)")
plt.title("How epsilon affects optimum lambda (sm KLD, ord)")
...
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (sm KLD, ord, mc)")
plt.title("How epsilon affects optimum lambda (sm KLD, ord, mc)")
plt.savefig("Synth_eps_lda_small_ord_mc.png")
plt.clf()

# plot optimum lambda for each epsilon (large KLD, sampled)
...
plt.plot(epsset, sLdaOpt[13], color = 'red', marker = '*', label = 'no noise')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (lg KLD, samp)")
plt.title("How epsilon affects optimum lambda (lg KLD, samp)")
plt.savefig("Synth_eps_large_samp_lda.png")
plt.clf()

# plot optimum lambda for each epsilon (large KLD, sampled, mc)
...
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (lg KLD, samp, mc)")
plt.title("How epsilon affects optimum lambda (lg KLD, samp, mc)")
plt.savefig("Synth_eps_lda_large_samp_mc.png")
plt.clf()
...
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (lg KLD, ord)")
plt.title("How epsilon affects optimum lambda (lg KLD, ord)")
...
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise error of unbiased estimator (lg KLD, ord, mc)")
plt.title("How epsilon affects optimum lambda (lg KLD, ord, mc)")
