...
for trial in range(14):
    ...
    for eps in epsset:
        ...
        if trial % 3 == 2:
            ...
            # eps = 0.05 (small)
            rMeanEpsSmall[trial, EPS_COUNT] = (rMeanEpsSmall[trial, EPS_COUNT] + rMeanSmallNoise - groundTruth)**2
            oMeanEpsSmall[trial, EPS_COUNT] = (oMeanEpsSmall[trial, EPS_COUNT] + oMeanSmallNoise - groundTruth)**2

            # eps = 0.5 (def)
            rMeanEpsDef[trial, EPS_COUNT] = (rMeanEpsDef[trial, EPS_COUNT] + rMeanDefNoise - groundTruth)**2
            oMeanEpsDef[trial, EPS_COUNT] = (oMeanEpsDef[trial, EPS_COUNT] + oMeanDefNoise - groundTruth)**2

            # eps = 1.5 (mid)
            rMeanEpsMid[trial, EPS_COUNT] = (rMeanEpsMid[trial, EPS_COUNT] + rMeanMidNoise - groundTruth)**2
            oMeanEpsMid[trial, EPS_COUNT] = (oMeanEpsMid[trial, EPS_COUNT] + oMeanMidNoise - groundTruth)**2

            # eps = 3 (large)
            rMeanEpsLarge[trial, EPS_COUNT] = (rMeanEpsLarge[trial, EPS_COUNT] + rMeanLargeNoise - groundTruth)**2
            oMeanEpsLarge[trial, EPS_COUNT] = (oMeanEpsLarge[trial, EPS_COUNT] + oMeanLargeNoise - groundTruth)**2
        ...
        # clients or intermediate server already added Gaussian noise term
            ...
            # eps = 0.05 (small)
            rMeanEpsSmall[trial, EPS_COUNT] = (rMeanEpsSmall[trial, EPS_COUNT] - groundTruth)**2
            oMeanEpsSmall[trial, EPS_COUNT] = (oMeanEpsSmall[trial, EPS_COUNT] - groundTruth)**2

            # eps = 0.5 (def)
            rMeanEpsDef[trial, EPS_COUNT] = (rMeanEpsDef[trial, EPS_COUNT] - groundTruth)**2
            oMeanEpsDef[trial, EPS_COUNT] = (oMeanEpsDef[trial, EPS_COUNT] - groundTruth)**2

            # eps = 1.5 (mid)
            rMeanEpsMid[trial, EPS_COUNT] = (rMeanEpsMid[trial, EPS_COUNT] - groundTruth)**2
            oMeanEpsMid[trial, EPS_COUNT] = (oMeanEpsMid[trial, EPS_COUNT] - groundTruth)**2

            # eps = 3 (large)
            rMeanEpsLarge[trial, EPS_COUNT] = (rMeanEpsLarge[trial, EPS_COUNT] - groundTruth)**2
            oMeanEpsLarge[trial, EPS_COUNT] = (oMeanEpsLarge[trial, EPS_COUNT] - groundTruth)**2
...
# plot error of PRIEST-KLD when epsilon = 0.05 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.05 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.05 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.05 (large KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.5 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.5 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.5 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 0.5 (large KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 1.5 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 1.5 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 1.5 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 1.5 (large KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 3 (small KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 3 (small KLD, ordered, mc)
...
# plot error of PRIEST-KLD when epsilon = 3 (large KLD, random +/-, mc)
...
# plot error of PRIEST-KLD when epsilon = 3 (large KLD, ordered, mc)
