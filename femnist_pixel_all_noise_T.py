...
plt.errorbar(Tset, meanLdaOpt[0], yerr = (min(meanLdaOpt[0], ldaStep),), color = 'tab:blue', marker = 'o', label = 'end lap')
plt.errorbar(Tset, meanLdaOpt[1], yerr = (min(meanLdaOpt[1], ldaStep),), color = 'tab:cyan', marker = 'x', label = 'end lap mc')
plt.errorbar(Tset, meanLdaOpt[2], yerr = (min(meanLdaOpt[2], ldaStep),), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(Tset, meanLdaOpt[3], yerr = (min(meanLdaOpt[3], ldaStep),), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(Tset, meanLdaOpt[4], yerr = (min(meanLdaOpt[4], ldaStep),), color = 'tab:red', marker = 'o', label = 'mid gauss')
plt.errorbar(Tset, meanLdaOpt[5], yerr = (min(meanLdaOpt[5], ldaStep),), color = 'tab:pink', marker = 'x', label = 'mid gauss mc')
plt.legend(loc = 'best')
plt.xscale('log')
plt.xlabel("Value of T")
...
plt.errorbar(Tset, minLdaOpt[0], yerr = (min(minLdaOpt[0], ldaStep),), color = 'tab:blue', marker = 'o', label = 'end lap')
plt.errorbar(Tset, minLdaOpt[1], yerr = (min(minLdaOpt[1], ldaStep),), color = 'tab:cyan', marker = 'x', label = 'end lap mc')
plt.errorbar(Tset, minLdaOpt[2], yerr = (min(minLdaOpt[2], ldaStep),), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(Tset, minLdaOpt[3], yerr = (min(minLdaOpt[3], ldaStep),), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(Tset, minLdaOpt[4], yerr = (min(minLdaOpt[4], ldaStep),), color = 'tab:red', marker = 'o', label = 'mid gauss')
plt.errorbar(Tset, minLdaOpt[5], yerr = (min(minLdaOpt[5], ldaStep),), color = 'tab:pink', marker = 'x', label = 'mid gauss mc')
plt.legend(loc = 'best')
plt.xscale('log')
plt.xlabel("Value of T")
...
plt.errorbar(Tset, maxLdaOpt[0], yerr = (min(maxLdaOpt[0], ldaStep),), color = 'tab:blue', marker = 'o', label = 'end lap')
plt.errorbar(Tset, maxLdaOpt[1], yerr = (min(maxLdaOpt[1], ldaStep),), color = 'tab:cyan', marker = 'x', label = 'end lap mc')
plt.errorbar(Tset, maxLdaOpt[2], yerr = (min(maxLdaOpt[2], ldaStep),), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(Tset, maxLdaOpt[3], yerr = (min(maxLdaOpt[3], ldaStep),), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(Tset, maxLdaOpt[4], yerr = (min(maxLdaOpt[4], ldaStep),), color = 'tab:red', marker = 'o', label = 'mid gauss')
plt.errorbar(Tset, maxLdaOpt[5], yerr = (min(maxLdaOpt[5], ldaStep),), color = 'tab:pink', marker = 'x', label = 'mid gauss mc')
plt.legend(loc = 'best')
plt.xscale('log')
plt.xlabel("Value of T")
