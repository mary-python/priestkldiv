...
plt.errorbar(Tset, meanLdaOpt[0], yerr = np.sqrt(meanLdaOpt[0]), color = 'tab:blue', marker = 'o', label = 'end lap')
plt.errorbar(Tset, meanLdaOpt[1], yerr = np.sqrt(meanLdaOpt[1]), color = 'tab:cyan', marker = 'x', label = 'end lap mc')
plt.errorbar(Tset, meanLdaOpt[2], yerr = np.sqrt(meanLdaOpt[2]), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(Tset, meanLdaOpt[3], yerr = np.sqrt(meanLdaOpt[3]), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(Tset, meanLdaOpt[4], yerr = np.sqrt(meanLdaOpt[4]), color = 'tab:red', marker = 'o', label = 'mid gauss')
plt.errorbar(Tset, meanLdaOpt[5], yerr = np.sqrt(meanLdaOpt[5]), color = 'tab:pink', marker = 'x', label = 'mid gauss mc')
plt.legend(loc = 'best')
plt.xscale('log')
plt.xlabel("Value of T")
...
plt.errorbar(Tset, minLdaOpt[0], yerr = np.sqrt(minLdaOpt[0]), color = 'tab:blue', marker = 'o', label = 'end lap')
plt.errorbar(Tset, minLdaOpt[1], yerr = np.sqrt(minLdaOpt[1]), color = 'tab:cyan', marker = 'x', label = 'end lap mc')
plt.errorbar(Tset, minLdaOpt[2], yerr = np.sqrt(minLdaOpt[2]), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(Tset, minLdaOpt[3], yerr = np.sqrt(minLdaOpt[3]), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(Tset, minLdaOpt[4], yerr = np.sqrt(minLdaOpt[4]), color = 'tab:red', marker = 'o', label = 'mid gauss')
plt.errorbar(Tset, minLdaOpt[5], yerr = np.sqrt(minLdaOpt[5]), color = 'tab:pink', marker = 'x', label = 'mid gauss mc')
plt.legend(loc = 'best')
plt.xscale('log')
plt.xlabel("Value of T")
...
plt.errorbar(Tset, maxLdaOpt[0], yerr = np.sqrt(maxLdaOpt[0]), color = 'tab:blue', marker = 'o', label = 'end lap')
plt.errorbar(Tset, maxLdaOpt[1], yerr = np.sqrt(maxLdaOpt[1]), color = 'tab:cyan', marker = 'x', label = 'end lap mc')
plt.errorbar(Tset, maxLdaOpt[2], yerr = np.sqrt(maxLdaOpt[2]), color = 'tab:olive', marker = 'o', label = 'end gauss')
plt.errorbar(Tset, maxLdaOpt[3], yerr = np.sqrt(maxLdaOpt[3]), color = 'tab:green', marker = 'x', label = 'end gauss mc')
plt.errorbar(Tset, maxLdaOpt[4], yerr = np.sqrt(maxLdaOpt[4]), color = 'tab:red', marker = 'o', label = 'mid gauss')
plt.errorbar(Tset, maxLdaOpt[5], yerr = np.sqrt(maxLdaOpt[5]), color = 'tab:pink', marker = 'x', label = 'mid gauss mc')
plt.legend(loc = 'best')
plt.xscale('log')
plt.xlabel("Value of T")
