...
# plot error of PRIEST-KLD when T = small (mean)
...
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[0]} (mean)")
plt.savefig("Femnist_T_est_mean_T_small.png")
plt.clf()

# plot error of PRIEST-KLD when T = small (mean, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[0]} (mean, mc)")
plt.savefig("Femnist_T_est_mean_mc_T_small.png")
plt.clf()

# plot error of PRIEST-KLD when T = small (min pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[0]} (min pair {minPair})")
plt.savefig("Femnist_T_est_min_T_small.png")
plt.clf()

# plot error of PRIEST-KLD when T = small (min pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[0]} (min pair {minPair}, mc)")
plt.savefig("Femnist_T_est_min_mc_T_small.png")
plt.clf()

# plot error of PRIEST-KLD when T = small (max pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[0]} (max pair {maxPair})")
plt.savefig("Femnist_T_est_max_T_small.png")
plt.clf()

# plot error of PRIEST-KLD when T = small (max pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[0]} (max pair {maxPair}, mc)")
plt.savefig("Femnist_T_est_max_mc_T_small.png")
plt.clf()

# plot error of PRIEST-KLD when T = default (mean)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[4]} (mean)")
plt.savefig("Femnist_T_est_mean_T_def.png")
plt.clf()

# plot error of PRIEST-KLD when T = default (mean, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[4]} (mean, mc)")
plt.savefig("Femnist_T_est_mean_mc_T_def.png")
plt.clf()

# plot error of PRIEST-KLD when T = default (min pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[4]} (min pair {minPair})")
plt.savefig("Femnist_T_est_min_T_def.png")
plt.clf()

# plot error of PRIEST-KLD when T = default (min pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[4]} (min pair {minPair}, mc)")
plt.savefig("Femnist_T_est_min_mc_T_def.png")
plt.clf()

# plot error of PRIEST-KLD when T = default (max pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[4]} (max pair {maxPair})")
plt.savefig("Femnist_T_est_max_T_def.png")
plt.clf()

# plot error of PRIEST-KLD when T = default (max pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[4]} (max pair {maxPair}, mc)")
plt.savefig("Femnist_T_est_max_mc_T_def.png")
plt.clf()

# plot error of PRIEST-KLD when T = mid (mean)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[7]} (mean)")
plt.savefig("Femnist_T_est_mean_T_mid.png")
plt.clf()

# plot error of PRIEST-KLD when T = mid (mean, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[7]} (mean, mc)")
plt.savefig("Femnist_T_est_mean_mc_T_mid.png")
plt.clf()

# plot error of PRIEST-KLD when T = mid (min pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[7]} (min pair {minPair})")
plt.savefig("Femnist_T_est_min_T_mid.png")
plt.clf()

# plot error of PRIEST-KLD when T = mid (min pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[7]} (min pair {minPair}, mc)")
plt.savefig("Femnist_T_est_min_mc_T_mid.png")
plt.clf()

# plot error of PRIEST-KLD when T = mid (max pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[7]} (max pair {maxPair})")
plt.savefig("Femnist_T_est_max_T_mid.png")
plt.clf()

# plot error of PRIEST-KLD when T = mid (max pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[7]} (max pair {maxPair}, mc)")
plt.savefig("Femnist_T_est_max_mc_T_mid.png")
plt.clf()

# plot error of PRIEST-KLD when T = large (mean)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[10]} (mean)")
plt.savefig("Femnist_T_est_mean_T_large.png")
plt.clf()

# plot error of PRIEST-KLD when T = large (mean, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[10]} (mean, mc)")
plt.savefig("Femnist_T_est_mean_mc_T_large.png")
plt.clf()

# plot error of PRIEST-KLD when T = large (min pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[10]} (min pair {minPair})")
plt.savefig("Femnist_T_est_min_T_large.png")
plt.clf()

# plot error of PRIEST-KLD when T = large (min pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[10]} (min pair {minPair}, mc)")
plt.savefig("Femnist_T_est_min_mc_T_large.png")
plt.clf()

# plot error of PRIEST-KLD when T = large (max pair)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[10]} (max pair {maxPair})")
plt.savefig("Femnist_T_est_max_T_large.png")
plt.clf()

# plot error of PRIEST-KLD when T = large (max pair, mc)
...
plt.xlabel("Value of lambda")
plt.ylabel("Error of PRIEST-KLD")
plt.title(f"Error of PRIEST-KLD when T = {Tset[10]} (max pair {maxPair}, mc)")
