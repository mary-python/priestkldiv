...
ax16.set_yscale('log')
ax16.set_yticks([60, 100, 200, 300])
ax16.set_ylim(60, 300)
...
ax17.set_yscale('log')
ax17.set_yticks([80, 90, 100, 120, 150])
ax17.set_ylim(80, 150)
...
ax18.set_yscale('log')
ax18.set_yticks([70, 100, 200, 300])
ax18.set_ylim(70, 350)
