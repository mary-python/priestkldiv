...
for C in range(0, 10):
    for D in range(0, 10):
        ...
        if ratio != 0.0 and sum(KLDiv[C, D]) != 0.0:
            ...
            unbias_est(0.06, ratio, lThreeKList, lThreeCDList, C, D)
            unbias_est(0.061, ratio, lNextKList, lNextCDList, C, D)
            unbias_est(0.0608, ratio, lHighKList, lHighCDList, C, D)
            unbias_est(0.06079, ratio, lLowKList, lLowCDList, C, D)
            unbias_est(0.060791, ratio, lDecideKList, lDecideCDList, C, D)
            ...
            unbias_est(0.028192, ratio, lMinKList, lMinCDList, C, D)
            unbias_est(0.091745, ratio, lMaxKList, lMaxCDList, C, D)
...
l3estfile.write("EMNIST: Unbiased Estimator Lambda = 0.06\n")
...
l4estfile.write("EMNIST: Unbiased Estimator Lambda = 0.061\n")
...
l5estfile.write("EMNIST: Unbiased Estimator Lambda = 0.0608\n")
...
l6estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l6est.txt", "w", encoding = 'utf-8')
l6estfile.write("EMNIST: Unbiased Estimator Lambda = 0.06079\n")
...
l7estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l7est.txt", "w", encoding = 'utf-8')
...
l8estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l8est.txt", "w", encoding = 'utf-8')
...
l9estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l9est.txt", "w", encoding = 'utf-8')
...
l10estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l10est.txt", "w", encoding = 'utf-8')
...
l11estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l11est.txt", "w", encoding = 'utf-8')
...
l12estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l12est.txt", "w", encoding = 'utf-8')
...
l13estfile = open(f"em_kld_mid_lap_noise_eps_{EPS}_l13est.txt", "w", encoding = 'utf-8')
