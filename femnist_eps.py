...
ax1.set_yscale('log')
ax1.set_ylim(0.001, 50000)
ax1.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax1.set_ylabel("MSE of PRIEST-KLD")
ax1.figure.savefig("Eps_exp1_est_a_0.05.png")
plt.close()
...
ax2.figure.savefig("Eps_exp1_eps_est_a_0.5.png")
plt.close()
...
ax3.figure.savefig("Eps_exp1_eps_est_a_3.png")
plt.close()
...
ax4.set_yscale('log')
ax4.set_ylim(0.01, 25000)
ax4.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax4.set_ylabel("MSE of PRIEST-KLD")
ax4.figure.savefig("Eps_exp1_eps_est_b_0.05.png")
plt.close()
...
ax5.figure.savefig("Eps_exp1_eps_est_b_0.5.png")
plt.close()
...
ax6.set_yscale('log')
ax6.set_ylim(0.01, 1000)
ax6.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax6.set_ylabel("MSE of PRIEST-KLD")
ax6.figure.savefig("Eps_exp1_eps_est_b_3.png")
plt.close()
...
ax7.figure.savefig("Eps_exp1_eps_est_c_0.05.png")
plt.close()
...
ax8.figure.savefig("Eps_exp1_eps_est_c_0.5.png")
plt.close()
...
ax9.figure.savefig("Eps_exp1_eps_est_c_3.png")
plt.close()
...
ax11.figure.savefig("Eps_exp2_eps_est_b.png")
plt.close()
...
ax12.figure.savefig("Eps_exp2_eps_est_c.png")
plt.close()
...
ax13.figure.savefig("Eps_exp2_eps_est_d.png")
plt.close()
...
ax14.figure.savefig("Eps_exp2_eps_est_e.png")
plt.close()
...
ax15.figure.savefig("Eps_exp2_eps_est_f.png")
plt.close()
...
ax16.figure.savefig("Eps_exp3_eps_perc_a.png")
plt.close()
...
ax17.figure.savefig("Eps_exp3_eps_perc_b.png")
plt.close()
...
ax18.figure.savefig("Eps_exp3_eps_perc_c.png")
plt.close()
