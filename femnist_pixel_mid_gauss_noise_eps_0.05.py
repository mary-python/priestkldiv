...
estfile = open("fem_est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
ratiofile = open("fem_ratio_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l0estfile = open("fem_l0est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l1estfile = open("fem_l1est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l2estfile = open("fem_l2est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l3estfile = open("fem_l3est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l4estfile = open("fem_l4est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l5estfile = open("fem_l5est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l6estfile = open("fem_l6est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l7estfile = open("fem_l7est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l8estfile = open("fem_l8est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l9estfile = open("fem_l9est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l10estfile = open("fem_l10est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l11estfile = open("fem_l11est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l12estfile = open("fem_l12est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
...
l13estfile = open("fem_l13est_kld_mid_gauss_noise_eps_0.05.txt", "w", encoding = 'utf-8')
