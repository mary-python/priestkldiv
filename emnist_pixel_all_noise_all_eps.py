...
trialset = ["mid_gauss", "mid_gauss_mc", "end_lap", "end_lap_mc", "end_gauss", "end_gauss_mc"]
ES = len(epsset)
TS = len(trialset)
...
plt.errorbar(epsset, aLambda[2], yerr = np.std(aLambda[2], axis = 0), color = 'tab:olive', marker = 'o', label = 'mid gauss')
plt.errorbar(epsset, aLambda[3], yerr = np.std(aLambda[3], axis = 0), color = 'tab:green', marker = 'x', label = 'mid gauss mc')
plt.errorbar(epsset, aLambda[4], yerr = np.std(aLambda[4], axis = 0), color = 'tab:red', marker = 'o', label = 'mid lap')
plt.errorbar(epsset, aLambda[5], yerr = np.std(aLambda[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc')
plt.legend(loc = 'best')
...
plt.errorbar(epsset, aPercLarge[5], yerr = np.std(aPercLarge[5], axis = 0), color = 'tab:pink', marker = 'x', label = 'mid lap mc: largest10%')
plt.legend(loc = 'best')
plt.xlabel("Value of epsilon")
