...
plt.ylabel("Lambda to minimise KLD")
...
plt.xlabel("Value of epsilon")
plt.ylabel("Lambda to minimise KLD")
plt.title("How epsilon affects lambda (min / max pair, EMNIST)")
...
plt.xlabel("Value of epsilon")
plt.ylabel("Minimal KLD")
plt.title("How epsilon affects minimal KLD (min / max pair, EMNIST)")
