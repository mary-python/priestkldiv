...
# INVESTIGATE option 1b: KLD is large
...
# INVESTIGATE option 2b: Monte-Carlo sampling
# b1 = 1 + log(2)
...
# INVESTIGATE option 3b: adding noise at end instead of middle
# dependent on eps but not generated for every client
