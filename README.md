...
- Download the Python files **femnist_eps.py** or **femnist_eps_low_Ct.py** and **femnist_eps_mid_Ct.py** and **femnist_eps_super_Ct.py**, if interested in the experiments involving the privacy parameter $\varepsilon$ and/or the client sample size $|C_t|$.
...
- If all outputs of **femnist_test.py** are as expected, open and run **femnist_eps.py** or **femnist_eps_low_Ct.py** and **femnist_all_noise_Ct_eps_mid.py** and **femnist_all_noise_Ct_eps_super.py**. There will be various text updates appearing in the terminal, indicating which experiment is being run.
