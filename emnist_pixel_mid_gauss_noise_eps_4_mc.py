...
estfile = open("em_est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
ratiofile = open("em_ratio_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l0estfile = open("em_l0est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l1estfile = open("em_l1est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l2estfile = open("em_l2est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l3estfile = open("em_l3est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l4estfile = open("em_l4est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l5estfile = open("em_l5est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l6estfile = open("em_l6est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l7estfile = open("em_l7est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l8estfile = open("em_l8est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l9estfile = open("em_l9est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l10estfile = open("em_l10est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l11estfile = open("em_l11est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l12estfile = open("em_l12est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
...
l13estfile = open("em_l13est_kld_mid_gauss_noise_eps_4_mc.txt", "w", encoding = 'utf-8')
