...
Ctset = [36, 72, 108, 144, 180, 225, 270, 315, 360, 450, 540, 600, 660, 720]
ES = len(Ctset)
...
for trial in range(4):
    ...
    for Ct in Ctset:
        ...
        meanPercRange[trial, Ct_FREQ] = np.std(tempMeanPerc)

        minEstRange[trial, Ct_FREQ] = np.std(tempMinEstMSE)
        minPercRange[trial, Ct_FREQ] = np.std(tempMinPerc)

        maxEstRange[trial, Ct_FREQ] = np.std(tempMaxEstMSE)
        maxPercRange[trial, Ct_FREQ] = np.std(tempMaxPerc)
...
ax1.figure.savefig("Exp1_femnist_Ct_est_a_36.png")
plt.close()
...
ax2.figure.savefig("Exp1_femnist_Ct_est_a_270.png")
plt.close()
...
ax3.figure.savefig("Exp1_femnist_Ct_est_a_720.png")
plt.close()
...
ax4.figure.savefig("Exp1_femnist_Ct_est_b_36.png")
plt.close()
...
ax5.figure.savefig("Exp1_femnist_Ct_est_b_270.png")
plt.close()
...
ax6.figure.savefig("Exp1_femnist_Ct_est_b_720.png")
plt.close()
...
ax7.figure.savefig("Exp1_femnist_Ct_est_c_36.png")
plt.close()
...
ax8.figure.savefig("Exp1_femnist_Ct_est_c_270.png")
plt.close()
...
ax9.figure.savefig("Exp1_femnist_Ct_est_c_720.png")
plt.close()
...
ax10.figure.savefig("Exp2_femnist_Ct_est_a.png")
plt.close()
...
ax11.figure.savefig("Exp2_femnist_Ct_est_b.png")
plt.close()
...
ax12.figure.savefig("Exp2_femnist_Ct_est_c.png")
plt.close()
...
ax13.figure.savefig("Exp2_femnist_Ct_est_d.png")
plt.close()
...
ax14.figure.savefig("Exp2_femnist_Ct_est_e.png")
plt.close()
...
ax15.figure.savefig("Exp2_femnist_Ct_est_f.png")
plt.close()

# EXPERIMENT 3: % of noise vs ground truth for each Ct
fig, ax16 = plt.subplots(layout = 'constrained')
plotline16a, caplines16a, barlinecols16a = ax16.errorbar(Ctset, meanPerc[0], yerr = np.minimum(meanPercRange[0], np.sqrt(meanPerc[0]), np.divide(meanPerc[0], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'blue', marker = 'o', label = "Dist")
plotline16b, caplines16b, barlinecols16b = ax16.errorbar(Ctset, meanPerc[1], yerr = np.minimum(meanPercRange[1], np.sqrt(meanPerc[1]), np.divide(meanPerc[1], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'green', marker = 'o', label = "TAgg")
plotline16c, caplines16c, barlinecols16c = ax16.errorbar(Ctset, meanPerc[2], yerr = np.minimum(meanPercRange[2], np.sqrt(meanPerc[2]), np.divide(meanPerc[2], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'orange', marker = 'o', label = "Trusted")
plotline16d, caplines16d, barlinecols16d = ax16.errorbar(Ctset, meanPerc[3], yerr = np.minimum(meanPercRange[3], np.sqrt(meanPerc[3]), np.divide(meanPerc[3], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'red', marker = '*', label = "no privacy")
...
ax16.set_xlabel("Client sample size " + "$\mathit{|C_{t}|}$")
ax16.set_ylabel("Noise (%)")
ax16.figure.savefig("Exp3_femnist_Ct_perc_a.png")
plt.close()

fig, ax17 = plt.subplots(layout = 'constrained')
plotline17a, caplines17a, barlinecols17a = ax17.errorbar(Ctset, minPerc[0], yerr = np.minimum(minPercRange[0], np.sqrt(minPerc[0]), np.divide(minPerc[0], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'blue', marker = 'o', label = "Dist")
plotline17b, caplines17b, barlinecols17b = ax17.errorbar(Ctset, minPerc[1], yerr = np.minimum(minPercRange[1], np.sqrt(minPerc[1]), np.divide(minPerc[1], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'green', marker = 'o', label = "TAgg")
plotline17c, caplines17c, barlinecols17c = ax17.errorbar(Ctset, minPerc[2], yerr = np.minimum(minPercRange[2], np.sqrt(minPerc[2]), np.divide(minPerc[2], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'orange', marker = 'o', label = "Trusted")
plotline17d, caplines17d, barlinecols17d = ax17.errorbar(Ctset, minPerc[3], yerr = np.minimum(minPercRange[3], np.sqrt(minPerc[3]), np.divide(minPerc[3], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'red', marker = '*', label = "no privacy")
...
ax17.set_xlabel("Client sample size " + "$\mathit{|C_{t}|}$")
ax17.set_ylabel("Noise (%)")
ax17.figure.savefig("Exp3_femnist_Ct_perc_b.png")
plt.close()

fig, ax18 = plt.subplots(layout = 'constrained')
plotline18a, caplines18a, barlinecols18a = ax18.errorbar(Ctset, maxPerc[0], yerr = np.minimum(maxPercRange[0], np.sqrt(maxPerc[0]), np.divide(maxPerc[0], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'blue', marker = 'o', label = "Dist")
plotline18b, caplines18b, barlinecols18b = ax18.errorbar(Ctset, maxPerc[1], yerr = np.minimum(maxPercRange[1], np.sqrt(maxPerc[1]), np.divide(maxPerc[1], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'green', marker = 'o', label = "TAgg")
plotline18c, caplines18c, barlinecols18c = ax18.errorbar(Ctset, maxPerc[2], yerr = np.minimum(maxPercRange[2], np.sqrt(maxPerc[2]), np.divide(maxPerc[2], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'orange', marker = 'o', label = "Trusted")
plotline18d, caplines18d, barlinecols18d = ax18.errorbar(Ctset, maxPerc[3], yerr = np.minimum(maxPercRange[3], np.sqrt(maxPerc[3]), np.divide(maxPerc[3], 2)),
                                                         uplims = upTset, lolims = loTset, color = 'red', marker = '*', label = "no privacy")
...
ax18.set_xlabel("Client sample size " + "$\mathit{|C_{t}|}$")
ax18.set_ylabel("Noise (%)")
ax18.figure.savefig("Exp3_femnist_Ct_perc_c.png")
plt.close()
