...
ax1.figure.savefig("Eps_low_exp1_Ct_est_a_36.png")
plt.close()
...
ax2.set_yscale('log')
ax2.set_ylim(0.006, 20000)
ax2.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax2.set_ylabel("MSE of PRIEST-KLD")
ax2.figure.savefig("Eps_low_exp1_Ct_est_a_270.png")
plt.close()
...
ax3.figure.savefig("Eps_low_exp1_Ct_est_a_540.png")
plt.close()
...
ax4.set_yscale('log')
ax4.set_ylim(0.06, 20000)
ax4.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax4.set_ylabel("MSE of PRIEST-KLD")
ax4.figure.savefig("Eps_low_exp1_Ct_est_b_36.png")
plt.close()
...
ax5.set_yscale('log')
ax5.set_ylim(0.003, 20000)
ax5.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax5.set_ylabel("MSE of PRIEST-KLD")
ax5.figure.savefig("Eps_low_exp1_Ct_est_b_270.png")
plt.close()
...
ax6.set_yscale('log')
ax6.set_ylim(0.006, 20000)
ax6.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax6.set_ylabel("MSE of PRIEST-KLD")
ax6.figure.savefig("Eps_low_exp1_Ct_est_b_540.png")
plt.close()
...
ax7.figure.savefig("Eps_low_exp1_Ct_est_c_36.png")
plt.close()
...
ax8.figure.savefig("Eps_low_exp1_Ct_est_c_270.png")
plt.close()
...
ax9.figure.savefig("Eps_low_exp1_Ct_est_c_540.png")
plt.close()
...
ax13.figure.savefig("Eps_low_exp2_Ct_est_d.png")
plt.close()
