...
EPS = 2 # higher eps to prevent noise from obscuring trends
DTA = 0.05
...
ax1.figure.savefig("Eps_mid_exp1_Ct_est_a_36.png")
plt.close()
...
ax2.figure.savefig("Eps_mid_exp1_Ct_est_a_270.png")
plt.close()
...
ax3.figure.savefig("Eps_mid_exp1_Ct_est_a_540.png")
plt.close()
...
ax4.figure.savefig("Eps_mid_exp1_Ct_est_b_36.png")
plt.close()
...
ax5.set_yscale('log')
ax5.set_ylim(0.01, 400)
ax5.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax5.set_ylabel("MSE of PRIEST-KLD")
ax5.figure.savefig("Eps_mid_exp1_Ct_est_b_270.png")
plt.close()
...
ax6.set_yscale('log')
ax6.set_ylim(0.01, 4000)
ax6.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax6.set_ylabel("MSE of PRIEST-KLD")
ax6.figure.savefig("Eps_mid_exp1_Ct_est_b_540.png")
plt.close()
...
ax7.figure.savefig("Eps_mid_exp1_Ct_est_c_36.png")
plt.close()
...
ax8.figure.savefig("Eps_mid_exp1_Ct_est_c_270.png")
plt.close()
...
ax9.figure.savefig("Eps_mid_exp1_Ct_est_c_540.png")
plt.close()
...
ax10.figure.savefig("Eps_mid_exp2_Ct_est_a.png")
plt.close()
...
ax11.figure.savefig("Eps_mid_exp2_Ct_est_b.png")
plt.close()
...
ax12.figure.savefig("Eps_mid_exp2_Ct_est_c.png")
plt.close()
...
ax13.figure.savefig("Eps_mid_exp2_Ct_est_d.png")
plt.close()
...
ax15.figure.savefig("Eps_mid_exp2_Ct_est_f.png")
plt.close()
