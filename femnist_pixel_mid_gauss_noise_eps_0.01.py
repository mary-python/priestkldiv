...
estfile = open("fem_est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
estfile.write("FEMNIST: Estimated KL Divergence In Order\n")
estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
ratiofile = open("fem_ratio_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
ratiofile.write("FEMNIST: Ratio Between Exact KL Divergence And Estimator\n")
ratiofile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l0estfile = open("fem_l0est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l0estfile.write("FEMNIST: Unbiased Estimator Lambda Zero\n")
l0estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l1estfile = open("fem_l1est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l1estfile.write("FEMNIST: Unbiased Estimator Lambda One\n")
l1estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l2estfile = open("fem_l2est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l2estfile.write("FEMNIST: Unbiased Estimator Lambda Half\n")
l2estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l3estfile = open("fem_l3est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l3estfile.write("FEMNIST: Unbiased Estimator Lambda Tenth\n")
l3estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l4estfile = open("fem_l4est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l4estfile.write("FEMNIST: Unbiased Estimator Lambda Next\n")
l4estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l5estfile = open("fem_l5est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l5estfile.write("FEMNIST: Unbiased Estimator Lambda High\n")
l5estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l6estfile = open("fem_l6est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l6estfile.write("FEMNIST: Unbiased Estimator Lambda Low\n")
l6estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l7estfile = open("fem_l7est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l7estfile.write("FEMNIST: Unbiased Estimator Lambda Decide\n")
l7estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l8estfile = open("fem_l8est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l8estfile.write("FEMNIST: Unbiased Estimator Lambda Minus\n")
l8estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l9estfile = open("fem_l9est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l9estfile.write("FEMNIST: Unbiased Estimator Lambda Triple\n")
l9estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l10estfile = open("fem_l10est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l10estfile.write("FEMNIST: Unbiased Estimator Lambda Min\n")
l10estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l11estfile = open("fem_l11est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l11estfile.write("FEMNIST: Unbiased Estimator Lambda Max\n")
l11estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l12estfile = open("fem_l12est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l12estfile.write("FEMNIST: Unbiased Estimator Lambda Pos\n")
l12estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
...
l13estfile = open("fem_l13est_kld_mid_gauss_noise_eps_0.01.txt", "w", encoding = 'utf-8')
l13estfile.write("FEMNIST: Unbiased Estimator Lambda Neg\n")
l13estfile.write("Gaussian Noise in Middle, no Monte Carlo, Eps = 0.01\n")
