...
estfile = open(f"fem_est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
ratiofile = open(f"fem_ratio_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l0estfile = open(f"fem_l0est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l1estfile = open(f"fem_l1est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l2estfile = open(f"fem_l2est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l3estfile = open(f"fem_l3est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l4estfile = open(f"fem_l4est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l5estfile = open(f"fem_l5est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l6estfile = open(f"fem_l6est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l7estfile = open(f"fem_l7est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l8estfile = open(f"fem_l8est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l9estfile = open(f"fem_l9est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l10estfile = open(f"fem_l10est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l11estfile = open(f"fem_l11est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l12estfile = open(f"fem_l12est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
...
l13estfile = open(f"fem_l13est_kld_mid_gauss_noise_eps_{EPS}.txt", "w", encoding = 'utf-8')
