...
EPS = 5 # higher eps to prevent noise from obscuring trends
DTA = 0.05
...
ax1.set_yscale('log')
ax1.set_ylim(0.07, 40)
ax1.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax1.set_ylabel("MSE of PRIEST-KLD")
ax1.figure.savefig("Eps_super_exp1_femnist_Ct_est_a_36.png")
plt.close()
...
ax2.figure.savefig("Eps_super_exp1_femnist_Ct_est_a_270.png")
plt.close()
...
ax3.figure.savefig("Eps_super_exp1_femnist_Ct_est_a_540.png")
plt.close()
...
ax4.figure.savefig("Eps_super_exp1_femnist_Ct_est_b_36.png")
plt.close()
...
ax5.figure.savefig("Eps_super_exp1_femnist_Ct_est_b_270.png")
plt.close()
...
ax6.set_yscale('log')
ax6.set_ylim(0.03, 3000)
ax6.set_xlabel("Value of " + "$\mathit{\u03bb}$")
ax6.set_ylabel("MSE of PRIEST-KLD")
ax6.figure.savefig("Eps_super_exp1_femnist_Ct_est_b_540.png")
plt.close()
...
ax7.figure.savefig("Eps_super_exp1_femnist_Ct_est_c_36.png")
plt.close()
...
ax8.figure.savefig("Eps_super_exp1_femnist_Ct_est_c_270.png")
plt.close()
...
ax9.figure.savefig("Eps_super_exp1_femnist_Ct_est_c_540.png")
plt.close()
...
ax11.figure.savefig("Eps_super_exp2_femnist_Ct_est_b.png")
plt.close()
...
ax12.figure.savefig("Eps_super_exp2_femnist_Ct_est_c.png")
plt.close()
...
ax14.figure.savefig("Eps_super_exp2_femnist_Ct_est_e.png")
plt.close()
