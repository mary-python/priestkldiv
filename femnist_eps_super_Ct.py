...
ax1.figure.savefig("Eps_super_exp1_Ct_est_a_36.png")
plt.close()
...
ax2.figure.savefig("Eps_super_exp1_Ct_est_a_270.png")
plt.close()
...
ax3.figure.savefig("Eps_super_exp1_Ct_est_a_540.png")
plt.close()
...
ax4.figure.savefig("Eps_super_exp1_Ct_est_b_36.png")
plt.close()
...
ax5.figure.savefig("Eps_super_exp1_Ct_est_b_270.png")
plt.close()
...
ax6.figure.savefig("Eps_super_exp1_Ct_est_b_540.png")
plt.close()
...
ax7.figure.savefig("Eps_super_exp1_Ct_est_c_36.png")
plt.close()
...
ax8.figure.savefig("Eps_super_exp1_Ct_est_c_270.png")
plt.close()
...
ax9.figure.savefig("Eps_super_exp1_Ct_est_c_540.png")
plt.close()
...
ax11.figure.savefig("Eps_super_exp2_Ct_est_b.png")
plt.close()
...
ax12.figure.savefig("Eps_super_exp2_Ct_est_c.png")
plt.close()
...
ax13.figure.savefig("Eps_super_exp2_Ct_est_d.png")
plt.close()
...
ax14.figure.savefig("Eps_super_exp2_Ct_est_e.png")
plt.close()
